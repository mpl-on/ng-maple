...
import { ɵstringify, Directive, Input, NgModule } from '@angular/core';
...
/** @nocollapse */ MapleModule.ɵfac = function MapleModule_Factory(t) { return new (t || MapleModule)(); };
/** @nocollapse */ MapleModule.ɵmod = /** @pureOrBreakMyCode */ i0.ɵɵdefineNgModule({ type: MapleModule });
/** @nocollapse */ MapleModule.ɵinj = /** @pureOrBreakMyCode */ i0.ɵɵdefineInjector({ imports: [CommonModule] });
(function () {
