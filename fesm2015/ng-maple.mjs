...
import { ɵisListLikeIterable, ɵstringify, Directive, Input, NgModule } from '@angular/core';
...
class Maple {
    ...
    static createDomElements(styleElements, prefix = 'maple', document) {
        ...
        const docHead = (document === null || document === void 0 ? void 0 : document.host)
            ? document
        ...
        breakpointsUp.concat(breakpointsDown.reverse()).forEach((key) => {
            ...
            const el = (document === null || document === void 0 ? void 0 : document.host) ? null : doc.getElementById(styleId);
            if (!!el) {
        ...
        for (const classItem of classList) {
            ...
            if (maple._default) {
                Object.keys(maple._default).forEach((mediaItem) => {
                    Maple.cache(mediaItem, Maple.getSelectors(null, selKey, utilKey, null, maple._selector, important, !!shadowRoot), Object.assign(Object.assign({}, maple._common), maple[maple._default[mediaItem]]), !!shadowRoot);
                });
            }
            ...
            if (utilVal) {
                ...
                Maple.cache(media, selector, Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, maple._common), maple[utilVal]), JSON.parse(JSON.stringify(maple[utilVal.replace(R_CUSTOM, WILDCARD)] || {}).replace(R_WILDCARD, utilKey === 'content'
                    ...
                    : utilKey === 'grid-areas'
                        ...
                        : utilVal
                            .replace(R_CUSTOM, '$1')
                            .replace(R_SEP_VAL_SPACE, ' ')))), (ucm[wcMediaKey] || {})), (ucm[wcutilKey] || {})), (ucm[wcMediaVal] || {})), (ucm[wcutilVal] || {})), (ucm[wcMedia] || {})), (ucm[c] || {})), { [IMPORTANT]: important }), !!shadowRoot);
            }
        }
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(MpClass, [{
            type: Directive,
            args: [{
                    selector: '[mpClass]',
                }]
...
/** @nocollapse */ /** @nocollapse */ MapleModule.ɵfac = function MapleModule_Factory(t) { return new (t || MapleModule)(); };
/** @nocollapse */ /** @nocollapse */ MapleModule.ɵmod = /** @pureOrBreakMyCode */ i0.ɵɵdefineNgModule({ type: MapleModule });
/** @nocollapse */ /** @nocollapse */ MapleModule.ɵinj = /** @pureOrBreakMyCode */ i0.ɵɵdefineInjector({ imports: [[CommonModule]] });
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(MapleModule, [{
            type: NgModule,
            args: [{
...
//# sourceMappingURL=ng-maple.mjs.map
